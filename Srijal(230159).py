...
def Result():
    ...
    if (i == 1):
        ...
        messagebox.showinfo('Srijal Joshi', 'Please Choose one of Encryption or Decrption. Try again.')
...
wn.title("Encrypt and Decrypt your Messages with Srijal Joshi")
